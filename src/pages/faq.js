...
import { P } from "../components/serviceComponents"
    ...
    <FaqWrap>
      ...
      <Accordion title="	Is Make My website a right company for my budget?">
        <P>
          ...
          researches keywords so that your clients can reach you easily.
        </P>
        <P>
          Our Prices are always in your budget, MMW offers affordable costs with
          better websites.
        </P>
      </Accordion>
      ...
      <Accordion title="	Do MMW build all the websites on WordPress?">
        <P>
          ...
          developers and our clients to have control over websites. If you want
          your website to work optimally and perform well on google, WordPress
      ...
      <Accordion title="Is it possible to make changes once the website is live?">
        <P>
          ...
          pictures, add/change text, modify minor designing. We will assist you
          with how to manage your website by yourself.
        </P>
        <P>
          But In case, if you want us to manage your website. We would be more
          than happy to do it for you. Our monthly charges will be $50 per
          month.
        </P>
      </Accordion>
      <Accordion title="	Do you design Logo too? Is Logo Important?">
        <P>
          Yes, we do create a incredible logo for your business or brand at a
          very minimal cost. And Logo is very important because it represents
          recognition to your organisation.
        </P>
      </Accordion>
      <Accordion title="What are MMW payment plans?">
        <P>
          We charge 50% of the amount quoted at the commencement of your website
          and will charge rest 50% amount on the completion of your website but
          once you will be fully satisfied with your website.
        </P>
      </Accordion>
      <Accordion title="Can you Upgrade/re-build my existing website?">
        <P>
          Absolutely, We can do that. We ensure we will come up far better and
          outstanding website.
        </P>
      </Accordion>
      <Accordion title="	Is it necessary to host a website with MMW?">
        <P>
          No, it’s not necessary. However, we prefer our customers to host their
          websites with MMW so that we can provide the continuous management and
          security of your website. It will be our responsibility to make sure
          working of your website and all server related issues.
        </P>
      </Accordion>
      <Accordion title="How my website will rank higher on Google and all other search engines? Is SEO important?">
        <P>
          Getting website is the first step to make your online presence on web,
          but definitely is not enough to rank higher on Google and other search
          engines. In a competitive online market, Search Engine Optimisation
          helps you organically rank higher using specific keywords relating
          your business. If your website rank high, it automatically grabs the
          attention of prospective clients. Our SEO experts are happy to assist
          you.
        </P>
      </Accordion>
      <P>
        <b>Please Get In Touch Today for more queries!</b>
      </P>
      {/* <ButtonItem>
      ...
      <AccorionDiv>
        ...
        <P>Our websites include (as per customer requirements) :
        <ul class="faq-list">
          <li>Web pages</li>
          <li>Responsive Designs</li>
          <li>Stock Images</li>
